...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    try {
      ...
      const pageId = "yatra21"; // Replace with the ID or username of the Facebook page 
      const accessToken = "EAAD6V7os0gcBO46k8hHo5LXDjs9J4P5AZAMmMJlJYz637ColtZAXEqfPEQAc74LnCQfjfS5MhtHG8NegQdjFhdSEZAv7eWyxApb2eE9c2z0pkyK8fd6V7wa1Poa6Omfvqa6GpBx0jyas0POX3x35d1scXVUUZAwUxgZAZCzaDV5SZCHIqyhP9jcr5NtVCci1bkSgwZDZD";// use your EAAD6V7 token
