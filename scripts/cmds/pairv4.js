...
module.exports = {
  ...
  onStart: async function({ api, event, threadsData, usersData }) {
    ...
    let gifLove = (await axios.get("https://i.ibb.co/GTJ6xsK/image.gif",
"https://i.ibb.co/NVvgT5X/image.gif",
"https://i.ibb.co/gg8w3zd/image.gif",
 { responseType: "arraybuffer" })).data;
    ...
    var msg = {
      body: `🙂Successful pairing!\n💌kati ramro  jodi Sadhai khusi huni 🙈😘\n💕Double ratio: ${tle}%\n${namee} 💗 ${name}`,
      mentions: arraytag,
      attachment: imglove
    };
